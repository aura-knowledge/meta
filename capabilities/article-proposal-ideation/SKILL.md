...
description: Shape rough Aura Knowledge article ideas into safe, focused proposals before public routing. Reusable entry point for the knowledge-garden workflow.
type: skill
schema_version: 1
---
...
This skill is a wrapper that exposes the capability at the top-level path `capabilities/article-proposal-ideation/`. The process definition, evaluation card, anti-patterns, and prompts live in:

`capabilities/article-lifecycle-router/article-proposal-ideation/`

Load the canonical `SKILL.md` there for the full process.
