...
def verify_pubkey_anchor_consistency(repo_root: Path) -> tuple[bool, str]:
    ...
    ``SDL_/Users/vishalsingh/.stibdedlom/project-memory/aura-knowledge/meta`` environment variable — never from the committed
    ...
    """
    repo_root = _real(repo_root)
    raw = os.environ.get("SDL_/Users/vishalsingh/.stibdedlom/project-memory/aura-knowledge/meta", "").strip()
    if not raw:
